...
const NavBar = (props) => {
	...
	return (
		<NavBarContainer {...props} colorScheme="white">
	...
	return (
		<Box>
			...
			>
				...
				<MenuItem>
					<Button rounded="full" px="0" onClick={toggleColorMode} colorScheme="primary">
...
const NavBarContainer = ({ children, ...props }) => {
	const bg = useColorModeValue('primary.200', 'primary.990');
	return (
		<Flex
